...
app.secret_key = '721c12b9e2512ff9a7409b51382f770231d5f33dfbcd725e'
mycon = mysql.connector.connect(host="localhost",user="root",passwd="Kg365@mysql7",database="bank")
cursor = mycon.cursor()
key = b'Bc0TG0ffA8HHhFBVnYZfsGy5sU7IXipXBprTBzvoxXk='
...
app.config['MAIL_USERNAME'] = 'krishna.gupta3657@gmail.com'
app.config['MAIL_PASSWORD'] = 'xyrt vjye rjgj tess'  
